...
if ($driver == 'mysql') {
    $PDO->exec("CREATE TABLE IF NOT EXISTS `" . TABLE_PREFIX . "approved_users_temp` (
...
$settings = array(
		...
		'welcome_email_pt' => 'Thank you for registering with Mensa Wales\r\n\r\nPlease validate your email address by clicking the link below:',
		'register_confirm_msg' => '<p>Thank you for registering. You will be sent an authorisation code that you must confirm to activate your account once your membership is validated.</p>',
		'welcome_email_pt_foot' => 'Thanks\r\n\r\nThe Team',
		'confirm_email_subject' => 'Thanks for registering',
		'confirm_email_from' => 'registrations@mensawales.org.uk',
		'confirm_email_reply' => '',
...
Plugin::setAllSettings($settings, "approved_users");
