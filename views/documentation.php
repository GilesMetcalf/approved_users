...
<h1><?php echo __('Approved users documentation'); ?></h1>

<h2><?php echo __('Quick start guide'); ?></h2>

<p>To quickly get up and running with the Approved Users plugin, there are two things you will need to do:</p>
...
<div style="border: 1px solid gray; background-color: lightblue; margin: 1em 0; padding: 0.5em;">
    <p>
        When a new user registers through the Approved Users plugin, the new user gets assigned
        a default role. In a standard, unchanged setup of the plugin, a role called "user" will automatically
        be created and used as the default role for newly approved users.
    </p>
    <p>
...
<p>
    A number of forms are used by the Approved Users plugin. Each of these forms have some defaults. If you wish to customize a form,
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>ap-registration</td>
            <td>The registration form.</td>
        </tr>
        <tr>
            <td>ap-confirmation</td>
