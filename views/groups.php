...
<p>
    ...
    website. You may want to add extra groups for Approved Users, Clients,
    ...
    <tbody>
        ...
        ?>
            ...
            <tr class="<?php echo odd_even(); ?>">
                <td><img src="<?php echo PLUGINS_URI; ?>approved_users/images/user_type_collections.png" align="top" alt="User Group" /> <?php echo '<strong>'.$name.'</strong>'; ?></td>
                <td style="text-align: left; width: 15em;"><?php
        if ($id >= '4') {
            echo '<a href="';
            echo get_url('plugin/approved_users/delete/');
            echo $id;
            ...
            $defaultusertype = Plugin::getSetting("default_permissions", "approved_users");
            if ($defaultusertype == $id) {
                echo ' <small><strong>[ Default Group ]</strong></small>';
            } else {
                echo ' <small>[ <a href="';
                echo get_url('plugin/approved_users/makedefault/');
                echo $id;
            ...
            $defaultusertyperetrieve = "SELECT * FROM ".TABLE_PREFIX."approved_users_settings";
        ...
        <tr>
            ...
            <td>
                <img src="<?php echo URL_PUBLIC; ?>wolf/plugins/approved_users/images/blank.png" align="middle" alt="User Group" />
