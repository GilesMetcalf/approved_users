...
<h1><?php echo __('Approved users settings');?></h1>
...
<form id="settings" action="<?php echo get_url('plugin/approved_users/edit_settings/'); ?>" method="post" style="margin: 2em 0em;">
...
?>>Yes</option>
    ...
    <div class="buttons">
        ...
        <?php echo __('or'); ?> <a href="<?php echo get_url('plugin/approved_users'); ?>"><?php echo __('Cancel'); ?></a>
    </div>
</form>
