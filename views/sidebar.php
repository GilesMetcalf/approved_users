...
<p class="button"><a href="<?php echo get_url('plugin/approved_users/fast_register_load'); ?>"><img src="<?php echo PLUGINS_URI; ?>approved_users/images/fastregister.png" align="middle"><?php echo __('Load Fast Register');?></a></p>
