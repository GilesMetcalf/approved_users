...
<h1><?php echo __('Approved Users'); ?></h1>
...
<table id="approved_users" class="index" cellpadding="0" cellspacing="0" border="0">
    <thead>
        <tr>
    ...
    <tbody>
        <tr>
            ...
            <td><small><strong><font color="red">&lt;?php</font> ap_login_page(); <font color="red">?&gt;</font></strong></small></td>
            <td><small>Displays login form and link to registration page.</small></td>
        </tr>
        <tr>
            <td><small><strong>Registration</strong></small></td>
            <td><small><strong><font color="red">&lt;?php</font> ap_register_page(); <font color="red">?&gt;</font></strong></small></td>
            <td><small>Displays registration form and link to login page.</small></td>
        </tr>
        <tr>
            <td><small><strong>Confirmation</strong></small></td>
            <td><small><strong><font color="red">&lt;?php</font> ap_confirm_page(); <font color="red">?&gt;</font></strong></small></td>
        ...
        <tr>
            ...
            <td><small><strong><font color="red">&lt;?php</font> ap_auth_required_page(); <font color="red">?&gt;</font></strong></small></td>
        ...
        <tr>
            ...
            <td><small><strong><font color="red">&lt;?php</font> ap_reset_page(); <font color="red">?&gt;</font></strong></small></td>
        ...
        <tr>
            ...
            <td><small><strong>
                        <font color="red">&lt;?php</font> ap_logout(); <font color="red">?&gt;</font></strong></small></td>
...
<p><strong>4. Set up the <a href="<?php echo get_url('plugin/approved_users/settings'); ?>">finer details.</a></strong></p>
