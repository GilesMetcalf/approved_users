...
/**
 * The ApprovedUser class contains the features needed to register a new user.
 * 
...
class ApprovedUser {
    ...
    public function login_page() {
        ...
        //$lf = $row['login_form'];
        $lf = new View('../../plugins/approved_users/views/login');
    ...
    function confirm() {
        ...
        $confirmation_page = Plugin::getSetting('confirmation_page', "approved_users");
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'GET') {
            ...
            if (!isset($_GET['id']) || !isset($_GET['email']) || empty($_GET['id']) || empty($_GET['email'])) {
                ...
                //$confirmation_page = new View('../../plugins/approved_users/views/confirm');
                //$auth_form = $row['auth_form'];
                $auth_form = new View('../../plugins/approved_users/views/confirm');
    ...
    function auth_required_page() {
        $auth_required_page_text = Plugin::getSetting('auth_required_page_text', "approved_users");
    ...
    function password_reset() {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            $email = trim($_POST['email']);
            $reset_no_email = Plugin::getSetting('reset_no_email', "approved_users");
            ...
            $reset_form = new View('../../plugins/approved_users/views/reset');
            $reset_page = Plugin::getSetting('reset_page', "approved_users");
            $reset_text = Plugin::getSetting('reset_text', "approved_users");
            echo $reset_text;
