...
class APCommon {
    ...
    public function confirmation_email($email,$name) {
        ...
        $registration_settings = "SELECT * FROM ".TABLE_PREFIX."approved_users_temp WHERE email=:email";
    ...
    function validateaccount($email,$rand_key_confirm) {
        ...
        if ($count > 0) {
            ...
            $registration_temp = "SELECT * FROM ".TABLE_PREFIX."approved_users_temp WHERE email='$email'";
            ...
            if ($rand_key_confirm == $rand_key) {
                ...
                $delete_temp_user ="DELETE FROM ".TABLE_PREFIX."approved_users_temp WHERE email='$email'";
                ...
                $def_permission = Plugin::getSetting("default_permissions", "approved_users");
                ...
                $loadloginclass = new ApprovedUser();
